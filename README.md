# ⏱️ Timer em JavaScript Puro

Este é um projeto simples de **timer** criado usando apenas **HTML, CSS e JavaScript puro** (Vanilla JS).  
Ele permite:
...
- Lógica limpa usando `setInterval`
